...
* All volunteer group from across Pharma and CROs coming together to do R-based Submissions
to the FDA.
* We are always experimenting and looking for ways to implement new ways of working and
latest technology and processes.
* Get involved!  More info [here](https://rconsortium.github.io/submissions-wg/join.html).
